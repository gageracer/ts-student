...
{:else}
	...
	<div class="list-body">
		...
		{#each $mydata.filter(t => ( t.firstName.concat('',t.lastName)).toLowerCase().includes(filterByName) && ( filterByTag != "" ?  t.tags.find(ele => ele.includes(filterByTag)): true ) ) as user,index}
