...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*handleSave*/ ctx[5], false, false, false),
    					listen_dev(button1, "click", /*fetchData*/ ctx[4], false, false, false)
    				];
    ...
    function create_each_block_1(ctx) {
    	...
    	binding_callbacks.push(() => bind(dinput, "inputVal", dinput_inputVal_binding));
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div0, t1);
    			append_dev(div1, t2);
    			mount_component(dinput, div1, null);
    			current = true;
    		},
    		p: function update(new_ctx, dirty) {
    			...
    			dinput.$set(dinput_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dinput.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dinput.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div1);
    			destroy_component(dinput);
    		}
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*$mydata*/ ctx[2].length == 0) return 0;
    		return 1;
    	}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $mydata,
    		...
    		$$subscribe_mydata = () => ($$unsubscribe_mydata(), $$unsubscribe_mydata = subscribe(mydata, $$value => $$invalidate(2, $mydata = $$value)), mydata);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-6cxj83");
